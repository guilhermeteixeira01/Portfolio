                ...
                <div className="My">
                    ...
                    <div className="boxbuttons">
                        ...
                        <div className="midiasocial">
                            <button className="iconBtn hireme" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="500">Hire Me</button>
                            ...
                            <button className="iconBtn linkedin" aria-label="LinkedIn" onClick={() => window.open("https://www.linkedin.com/in/guilherme-teixeira-86499732a/", "_blank")} data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="500">
                                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                ...
                <div className="box">
                    ...
                    <div className="boxachievements">
                        ...
                        <div className="achievements">
                            ...
                            <img src={QuickDraw} onClick={() => setOpenCard(4)} data-aos="fade-up"
                                data-aos-duration="1500" data-aos-delay="400" />
                            <img src={Yolo} onClick={() => setOpenCard(5)} data-aos="fade-up"
                                data-aos-duration="1500" data-aos-delay="500" />
                            <img src={StarStruck} onClick={() => setOpenCard(6)} data-aos="fade-up"
